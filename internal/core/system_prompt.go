...
const (
	systemPromptIntro = "You are an expert coding assistant operating inside pi, a coding agent harness. " +
		"You help users by reading files, executing commands, editing code, and writing new files."
	documentationHeader = "Pi documentation (read only when the user asks about pi itself, its SDK, " +
...
// BuildSystemPromptOptions controls Pi-style system prompt construction.
...
// BuildSystemPrompt builds the default Pi coding-agent prompt in Go.
