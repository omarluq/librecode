...
func setDefaults(viperInstance *viper.Viper) {
	...
	viperInstance.SetDefault("delegation.provider", "")
	viperInstance.SetDefault("delegation.model", "")
	viperInstance.SetDefault("delegation.thinking_level", "")
	...
	viperInstance.SetDefault("context.extension_contribution_tokens", defaultExtensionContributionTokens)
	viperInstance.SetDefault("context.auto_compaction_enabled", true)
	viperInstance.SetDefault("context.auto_compaction_threshold", defaultAutoCompactionThreshold)
	viperInstance.SetDefault("context.retained_tail_max_tokens", defaultRetainedTailMaxTokens)
	viperInstance.SetDefault("context.summary_output_tokens", 0)
	viperInstance.SetDefault("context.compaction_provider", "")
	viperInstance.SetDefault("context.compaction_model", "")
