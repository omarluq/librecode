...
func configEntries(cfg *config.Config) []configEntry {
	return []configEntry{
		...
		{key: "delegation.provider", value: cfg.Delegation.Provider},
		{key: "delegation.model", value: cfg.Delegation.Model},
		{key: "delegation.thinking_level", value: cfg.Delegation.ThinkingLevel},
